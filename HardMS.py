...
#grid dimensions
x, y, width, height = (752, 192, 1200, 1000)
cell_size = 50
grid_rows = 20
grid_cols = 24
...
def main():
    ...
    actions.move_to_element_with_offset(easyButton, 0, 50)
    ...
    while boolean:
        ...
        if next_move:
            for move in next_move:
                row, col = move
                yCoord = (row * cell_size) + cell_size/2 + y
                xCoord = (col * cell_size) + cell_size/2 + x
